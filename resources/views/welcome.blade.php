...
<head>
    ...
    <!-- ==========================
        Title
    =========================== -->
    <title>Bruce Cameron - Freelance Sign Language Interpreter - Glasgow, Scotland</title>
...
<body id="page-top">
   ...
   <!-- ==========================
    ...
    <header>
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <img src="image/bruce2.png" class="navbar-logo pull-left" alt="" />
                ...
                <div class="collapse navbar-collapse" id="myNavigation">
                    <ul class="nav navbar-nav navbar-right animated flipInX">
                        <li><a href="/booking" class="scroll">Make A Booking</a></li>
        ...
        <div class="jumbotron">
            <img src="image/bruce2.png" class="img-responsive scrollpoint sp-effect3" alt="" />
            <div class="social-wrapper">
                ...
                <h2 class="scrollpoint sp-effect3">Bruce Cameron</h2>
            ...
            <div id="slideshow" class="carousel slide vertical scrollpoint sp-effect3" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="item active"><h3>Freelance Sign Language Interpreter</div>
                    <!-- Slideshow item 2 -->
                    <div class="item"><h3>Full SASLI Member</h3></div>
                    <!-- Slideshow item 3 -->
                    <div class="item"><h3>Based In Glasgow, Scotland</h3></div>
                </div>
            </div>
            <!-- Slideshow end -->
        <a href="/booking" class="btn btn-reference btn-lg scroll scrollpoint sp-effect1" role="button"><i class="fa fa-calendar"></i> Make A Booking</a>
        <a href="#contact" class="btn btn-reference btn-lg btn-active scroll scrollpoint sp-effect2" role="button"><i class="fa fa-envelope-o"></i> Contact Me</a>
        </div>
    </header>
    <!-- ==========================
        HEADER - END
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-2 hidden-xs scrollpoint sp-effect1"><!-- Profile image -->
                    <img src="image/bruce2.png" class="image-bordered img-responsive" alt="" />
                </div><!-- Profile end -->

                <div class="col-md-7 col-sm-6 scrollpoint sp-effect1"><!-- Profile description -->
                    <h3>Bruce Cameron</h3>
                    <p>After being born to deaf parents it was inevitable that I would find myself very much at home working with the deaf community.</p>
                    <p>I love my job because of the huge variety of jobs I'm asked to work on, and the inspiring people I'm lucky to work with.</p>
                    <p>I'm excited for the future of interpreting for the deaf especially as technology is dramatically enhancing the lives of many deaf people.
              ...
              <div class="col-md-3 col-sm-4 scrollpoint sp-effect2"><!--Timeline-->
                  ...
                  <div class="timeline">
                      ...
                      <div class="event">
                          ...
                          <span>Began Training with Deaf Connections via SASLI</span>
                      </div> <!-- BLOG POST 1 - END -->
                ...
                <div class="col-sm-12">
                    ...
                    <div class="macbook-inner black">
                        <div class="row scrollpoint sp-effect4">
                                ...
                                <form role="form" id="contactForm">
                                    ...
                                    <div class="form-group control-group">
                                        <div class="controls">
                                            ...
                                            <input type="text" class="form-control" placeholder="Name" id="name" data-validation-required-message="Please enter your name." aria-invalid="false">
                                        </div>
                                    </div>
                            ...
                            <img src="image/bruce2.png" class="contact-image image-responsive hidden-xs hidden-sm" alt="" />
                                <div class="contact-info">
                                    <p>30 Spey Grove</p>
                                    <p>East Kilbride, G75 8XH</p>
                                    <p><a href="mailto:lafuvisual@gmail.com">lafuvisual@gmail.com</a></p>
                                    <p>07775 558082</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12 scrollpoint sp-effect3">
                        ...
                        <div style="margin: 20px 0 30px">
                            <a href="/booking" class="btn btn-primary">Make A Booking</a>
                        </div>
